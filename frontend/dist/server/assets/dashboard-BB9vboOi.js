...
import { Link2, CheckCircle2, Calendar, Clock, ShieldCheck, Download, Layers, Users, Boxes, UserMinus, MousePointerClick, Play, Info, AlertCircle, X } from "lucide-react";
import { u as useOrganizerEventLive, D as DashboardShell, f as formatJoinedAt } from "./DashboardShell-B9XKxzi0.js";
import { i as isOrganizerAuthenticated, a as apiClient } from "./router-CXCreoWL.js";
...
import { S as SCHEDULE_WINDOW_DAYS } from "./booking-D7b6t-Ng.js";
...
function DashboardPage() {
  ...
  const paymentPending = !isLoading && !isError && !!organizer?.payment_status && organizer.payment_status !== "paid";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "border-t border-border/60 px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 gap-0 text-sm", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 border-l border-border/60 pl-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "font-semibold mt-0.5", children: booking?.booking_id ? /* @__PURE__ */ jsx("button", { onClick: async () => {
              ...
              }, disabled: invoiceDownloading, className: "text-primary hover:underline disabled:opacity-50 disabled:cursor-not-allowed", children: invoiceDownloading ? "preparing…" : "download" }) : /* @__PURE__ */ jsx("span", { className: "text-muted", children: "—" }) })
            ] })
          ] })
        ] }) })
      ] }),
    ...
    paymentPending && /* @__PURE__ */ jsx(PaymentRequiredModal, { onPay: () => navigate({
      to: "/create",
      search: {
        activity: void 0
      }
...
function PaymentRequiredModal({
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-3xl shadow-elevated w-full max-w-md overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-200", children: [
    /* @__PURE__ */ jsxs("div", { className: "px-6 py-6 text-center", children: [
      /* @__PURE__ */ jsx("div", { className: "mx-auto grid h-14 w-14 place-items-center rounded-full bg-amber-100 text-amber-600", children: /* @__PURE__ */ jsx(AlertCircle, { className: "h-7 w-7" }) }),
      /* @__PURE__ */ jsx("h3", { className: "mt-4 text-xl font-bold text-foreground", children: "Complete your payment" }),
      /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground leading-relaxed", children: "Your email is verified, but your package isn't active yet. Choose your activity, package & schedule and complete the payment to activate your account and access the dashboard." })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2.5 px-6 pb-6", children: [
      /* @__PURE__ */ jsx("button", { onClick: onPay, className: "w-full rounded-full bg-gradient-primary text-white py-3 text-sm font-semibold shadow-glow hover:opacity-90 transition-opacity", children: "Complete Payment & Activate" }),
      /* @__PURE__ */ jsx("button", { onClick: onLogout, className: "w-full rounded-full border border-border py-2.5 text-sm font-medium text-foreground/80 hover:bg-muted transition-colors", children: "Log out" })
    ] })
  ] }) });
}
