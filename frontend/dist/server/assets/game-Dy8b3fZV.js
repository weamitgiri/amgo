...
import { c as cookAndCreateService, C as CookCreateLayout } from "./cookandcreate.service-BqBEKgTl.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 w-full max-w-[700px] bg-[#FFF5E6] rounded-[28px] border border-[#F5D8B6] shadow-2xl overflow-hidden p-6 md:p-8 animate-in fade-in zoom-in-95 duration-200", children: [
      ...
      resultMode ? (
        ...
        /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-[#6E5A44] mb-5 leading-relaxed", children: "Following steps were selected based on the team's votes:" }),
          /* @__PURE__ */ jsx("div", { className: "bg-[#FFEAD1]/50 rounded-2xl border border-[#F5CE9E]/60 overflow-hidden", children: keptSteps.length === 0 ? /* @__PURE__ */ jsx("p", { className: "px-5 py-8 text-sm text-center text-[#8B7355]", children: "No steps remained after the vote." }) : keptSteps.map((step, i) => /* @__PURE__ */ jsxs(
            "div",
            {
              className: `flex items-start gap-3 px-5 py-3.5 ${i < keptSteps.length - 1 ? "border-b border-[#F5CE9E]/40" : ""}`,
              children: [
                /* @__PURE__ */ jsxs("span", { className: "text-base font-black text-[#E8881E] shrink-0", children: [
                  "Step ",
        ...
        /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4 mb-6 flex-wrap", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 bg-white/70 border border-[#F5E2C8] rounded-xl px-4 py-2", children: [
