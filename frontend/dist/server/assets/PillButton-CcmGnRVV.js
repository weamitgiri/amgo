...
function PillButton({
  ...
  return /* @__PURE__ */ jsxs("button", { className: `${base} ${styles[variant]} ${className}`, ...props, children: [
    children,
    withArrow && (variant === "light" || variant === "primary") && /* @__PURE__ */ jsx("span", { className: `grid h-8 w-8 place-items-center rounded-full transition-transform group-hover:translate-x-0.5 ${variant === "light" ? "bg-[#8B5CF6] text-white" : "bg-white/20 text-white"}`, children: /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" }) })
  ] });
}
export {
  PillButton as P
