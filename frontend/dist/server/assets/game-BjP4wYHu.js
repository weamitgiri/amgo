...
import { FileText, Lightbulb, Gamepad2, Camera, ScanSearch, UserX, Clock, ShieldCheck, Eye, X, ZoomIn, Video, Cloud, Calendar, MapPin } from "lucide-react";
import { L as Logo } from "./Logo-B423IJ3f.js";
import { p as participantService } from "./participant.service-BqNWWUmy.js";
...
import { c as Route } from "./router-CXCreoWL.js";
...
const caseCollage = "/assets/case-summary-collage-CHlGsjOK.png";
const suspectBanner = "/assets/Group%201000004660-DmJGD4tC.png";
...
function GamePage() {
  ...
  const [finalVerdictEndsAt, setFinalVerdictEndsAt] = useState(null);
  ...
  const [tallyByQuestionId, setTallyByQuestionId] = useState(/* @__PURE__ */ new Map());
  ...
  const applyGameState = useCallback((state) => {
    ...
    const activityItems = state.group.questions.map((q) => {
      ...
      return {
        ...
        tally: isLie ? voteTallies.get(q.id) : void 0,
        isLie
      };
    });
  ...
  useEffect(() => {
    ...
    const onNewAnswer = (a) => {
      ...
      if (lieDetectorRoundId && !a.auto_skipped && Number(myPlayer?.session_id) !== Number(a.participant_session_id)) {
        setVoteContext({
    ...
    const onPhaseChanged = (payload) => {
      ...
      if (payload.new_phase === "final_verdict") {
        ...
        setVoteContext(null);
        setPendingAnswerForMe(null);
        const endsAt = payload.ends_at ? new Date(payload.ends_at.replace(" ", "T")).getTime() : Date.now() + 12e4;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#0e0817] text-white p-4 md:p-6 font-sans", children: [
    ...
    finalVerdictActive ? /* @__PURE__ */ jsx(FinalAccusationModal, { players, victimName: gameData.game.victim_name, isCulprit, submitted: myAccusationSubmitted, endsAtMs: finalVerdictEndsAt, onSubmit: handleAccuse }) : modal === "accuse" && !isCulprit && /* @__PURE__ */ jsx(AccuseModal, { players, victimName: gameData.game.victim_name, submitted: myAccusationSubmitted, onSubmit: handleAccuse, onClose: () => setModal(null) }),
...
function InstinctWarningModal({
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[70] grid place-items-center bg-black/80 backdrop-blur-sm p-4", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-lg rounded-3xl border border-white/15 bg-purple-950/95 shadow-elevated p-7 text-center", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm leading-relaxed text-white/80", children: "This is a game of human instinct, not internet searches. Put the phone down, study the clues, question your suspects, and trust yourself Do not use AI tools, Google, the internet, or any other external source to solve the case. All answers must come from the information provided in the game." }),
    /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-white/70", children: "If you are suspected of cheating or using external tools, you may be removed from the game. Play fair. Trust yourself. Solve the mystery." }),
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-8 grid gap-8 md:grid-cols-[1.3fr_1fr]", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-6 text-[15px] leading-[1.6]", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative mt-4 inline-block w-full max-w-[440px] rotate-[-1deg]", children: [
                /* @__PURE__ */ jsx("img", { src: suspectBanner, alt: "", className: "w-full h-auto select-none pointer-events-none drop-shadow-[2px_3px_6px_rgba(0,0,0,0.4)]" }),
                /* @__PURE__ */ jsxs("span", { className: "absolute inset-0 flex items-center justify-center px-8 text-center text-[13px] md:text-sm text-[#2b1608] font-medium", children: [
                  "Now, ",
            ...
            /* @__PURE__ */ jsx("div", { className: "relative flex items-start justify-center", children: /* @__PURE__ */ jsx("img", { src: caseCollage, alt: "Investigation evidence — crime scene photos and quick facts", className: "w-full max-w-[440px] h-auto object-contain drop-shadow-2xl" }) })
          ] })
        ] }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "mt-5 rounded-2xl border border-[#3b2a59] bg-[#1a0f2e] px-6 py-5 flex items-center gap-4 flex-wrap pb-7", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "ml-auto flex items-center gap-6 flex-wrap", children: [
        ...
        !isCulprit && /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col items-center justify-center", children: [
          /* @__PURE__ */ jsxs("button", { onClick: () => finalVerdictActive && openModal("accuse"), disabled: myAccusationSubmitted || !finalVerdictActive, title: !finalVerdictActive ? "Unlocks automatically when the game time ends" : void 0, className: "inline-flex items-center gap-2 rounded-full bg-[#f43f5e] px-5 py-2.5 text-[13px] font-semibold text-white hover:opacity-90 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed", children: [
            /* @__PURE__ */ jsx(UserX, { className: "h-4 w-4" }),
            " ",
            myAccusationSubmitted ? "Accusation Submitted" : "Final Accusation"
          ] }),
          !finalVerdictActive && !myAccusationSubmitted && /* @__PURE__ */ jsx("div", { className: "absolute -bottom-5 text-[10px] text-white/40 whitespace-nowrap", children: "Unlocks when time ends" })
        ] })
      ] })
    ] }),
        ...
        /* @__PURE__ */ jsx("div", { className: "space-y-4", children: players.map((p, i) => {
          ...
          return /* @__PURE__ */ jsxs("button", { type: "button", disabled: p.is_you || frozen, onClick: () => {
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
              ...
              p.character_name && /* @__PURE__ */ jsx("div", { className: "text-[12px] text-purple-300/90 break-words leading-tight mt-0.5", children: p.character_name }),
            ...
            /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-6 justify-start", children: players.map((p, i) => {
              ...
              return /* @__PURE__ */ jsx("div", { className: `flex flex-col items-center gap-0 ${frozen ? "opacity-40" : ""}`, children: /* @__PURE__ */ jsxs("div", { className: "relative w-[120px] h-[155px] rounded-2xl flex flex-col items-center justify-center gap-3 border border-[#4a3473] bg-transparent", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "text-[14px] text-white leading-tight text-center flex flex-col items-center gap-0.5", children: [
                  p.pseudonym,
                  p.is_you && /* @__PURE__ */ jsx("span", { className: "text-[11px] text-white/70", children: "(You)" }),
                  p.character_name && /* @__PURE__ */ jsx("span", { className: "text-[11px] text-purple-300/90 leading-tight", children: p.character_name })
                ] })
              ] }) }, p.session_id);
            }) })
          ] }) }),
            ...
            feedItems.map((a) => {
              ...
              return /* @__PURE__ */ jsxs("li", { className: "rounded-xl bg-[#2a174c] border border-transparent p-4 relative", children: [
                ...
                a.a && /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-start gap-3 relative", children: [
                  ...
                  a.isLie && (tallyByQuestionId.get(a.questionId) ?? a.tally) && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-3 text-right space-y-2", children: [
                    /* @__PURE__ */ jsxs("div", { className: "text-sm text-emerald-400", children: [
                      "Believable (",
                      (tallyByQuestionId.get(a.questionId) ?? a.tally).believable,
                      ")"
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "text-sm text-rose-400", children: [
                      "Suspicious (",
                      (tallyByQuestionId.get(a.questionId) ?? a.tally).suspicious,
                      ")"
                    ] })
                  ] })
                ] }),
...
function AnswerModal({
  ...
  const fmt = (s) => `${String(Math.floor(s / 60)).padStart(2, "0")}:${String(s % 60).padStart(2, "0")}`;
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 grid place-items-center bg-black/70 backdrop-blur-sm p-3 overflow-y-auto py-4", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-lg rounded-2xl border border-[#4a2f78] bg-gradient-to-br from-[#33215c] to-[#1d1236] shadow-elevated", children: [
    /* @__PURE__ */ jsx("button", { "aria-hidden": true, tabIndex: -1, className: "absolute top-5 right-5 z-10 h-10 w-10 grid place-items-center rounded-xl bg-[#7c3aed]/25 border border-purple-400/40 text-white/80 cursor-not-allowed", children: /* @__PURE__ */ jsx(X, { className: "h-4 w-4" }) }),
    /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsx("div", { className: "h-12 w-12 rounded-full border border-white/10 bg-black/50 grid place-items-center", children: /* @__PURE__ */ jsx(ShieldCheck, { className: "h-6 w-6 text-purple-300" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-6 rounded-2xl border border-purple-400/30 bg-[#3a2260]/40 p-6 text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "text-sm text-white/70 mb-2", children: "Question" }),
        /* @__PURE__ */ jsx("div", { className: "text-lg md:text-xl text-white leading-relaxed font-medium", children: question })
      ] }),
...
function ClueRoomModal({
  ...
  if (zoomedImage) {
    return /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[60] flex items-center justify-center bg-black/90 backdrop-blur p-4", onClick: () => setZoomedImage(null), children: [
      /* @__PURE__ */ jsx("button", { className: "absolute top-6 right-6 h-10 w-10 grid place-items-center rounded-full bg-white/10 hover:bg-white/20 text-white", children: /* @__PURE__ */ jsx(X, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsx("img", { src: zoomedImage, alt: "Zoomed Clue", className: "max-h-[90vh] max-w-[90vw] object-contain rounded-xl shadow-2xl", onClick: (e) => e.stopPropagation() })
    ] });
  }
  if (!unlocked) {
  ...
  return /* @__PURE__ */ jsx(ModalShell, { onClose, max: "max-w-2xl", children: /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-6 grid gap-4 md:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-white/10 bg-white/5 p-4", children: [
        ...
        clueImageUrl ? /* @__PURE__ */ jsxs("div", { onClick: () => setZoomedImage(clueImageUrl), className: "relative group mt-3 overflow-hidden rounded-xl bg-zinc-900 cursor-zoom-in", children: [
          /* @__PURE__ */ jsx("img", { src: clueImageUrl, alt: firstClue?.clue_title ?? "Clue", className: "h-36 w-full object-cover" }),
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-1.5 right-1.5 h-7 w-7 rounded-full bg-white/90 text-zinc-800 grid place-items-center", children: /* @__PURE__ */ jsx(ZoomIn, { className: "h-3.5 w-3.5" }) })
        ] }) : null
      ] })
    ] }),
...
function FinalAccusationModal({
  ...
  const [reason, setReason] = useState("");
  const candidates = players.filter((p) => !p.is_you);
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[70] flex items-center justify-center bg-black/85 backdrop-blur p-4", children: /* @__PURE__ */ jsx("div", { className: "w-full max-w-2xl rounded-2xl border border-rose-500/30 bg-[#160b28] shadow-2xl", children: /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: "h-12 w-12 rounded-full border border-rose-400/50 bg-rose-500/10 grid place-items-center", children: /* @__PURE__ */ jsx(UserX, { className: "h-5 w-5 text-rose-300" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold", children: victimName ? `Who Killed ${victimName}?` : "Make Your Final Accusation" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-white/65", children: "Time's up. The investigation is over — name the killer before the window closes." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "text-right shrink-0", children: [
        /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-widest text-white/50", children: "Time left" }),
        /* @__PURE__ */ jsx(DeadlineCountdown, { endsAtMs, className: "text-rose-400 text-2xl font-black tabular-nums leading-none" })
      ] })
    ] }),
    isCulprit ? /* @__PURE__ */ jsxs("div", { className: "mt-8 text-center", children: [
      /* @__PURE__ */ jsx("p", { className: "text-sm text-white/80", children: "You are the culprit — sit tight while the group decides your fate." }),
      /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs text-white/50", children: "The results are revealed as soon as everyone has accused, or when the timer runs out." })
    ] }) : submitted ? /* @__PURE__ */ jsx("p", { className: "mt-8 text-center text-sm text-emerald-300", children: "Your accusation is locked in. Waiting for the other players and the final verdict…" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("div", { className: "mt-5 grid grid-cols-5 gap-2", children: candidates.map((p, i) => /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => setPickSessionId(p.session_id), className: `relative rounded-xl border p-2 text-center ${pickSessionId === p.session_id ? "border-purple-400 ring-2 ring-purple-400/40 bg-purple-500/10" : "border-white/10 bg-white/5 hover:bg-white/10"}`, children: [
        /* @__PURE__ */ jsx("div", { className: `mx-auto h-14 w-14 rounded-full bg-gradient-to-br ${PLAYER_GRADS[i % PLAYER_GRADS.length]} grid place-items-center text-sm font-bold`, children: p.pseudonym.slice(0, 2).toUpperCase() }),
        /* @__PURE__ */ jsx("div", { className: "mt-1.5 text-[11px] font-semibold", children: p.pseudonym }),
        pickSessionId === p.session_id && /* @__PURE__ */ jsx("div", { className: "absolute -bottom-2 left-1/2 -translate-x-1/2 h-4 w-4 rounded-full bg-purple-500 ring-2 ring-purple-300" })
      ...
      /* @__PURE__ */ jsx("button", { type: "button", onClick: () => pickSessionId != null && onSubmit(pickSessionId, reason.trim()), disabled: pickSessionId == null || !reason.trim(), className: "mt-5 block text-center w-full rounded-full bg-gradient-primary py-3 text-sm font-semibold shadow-glow disabled:opacity-40 disabled:cursor-not-allowed", children: "Submit Final Accusation" }),
      /* @__PURE__ */ jsx("p", { className: "mt-2 text-center text-[11px] text-white/60", children: "Choose carefully. Once submitted, you cannot change your answer." })
    ] })
  ] }) }) });
}
