...
import { C as CookCreateLayout, c as cookAndCreateService } from "./cookandcreate.service-BqBEKgTl.js";
...
import { p as portraitForRole } from "./portraits-H6cR_Aza.js";
...
function ReviewRatingPage({
  ...
  const withCounts = ratingCategories.map((c) => ({ ...c, count: reactionCounts[c.slug] ?? 0 })).filter((c) => c.count > 0).sort((a, b) => b.count - a.count);
  const hasReactions = withCounts.length > 0;
  const reactionCards = hasReactions ? withCounts.slice(0, 5) : ratingCategories.slice(0, 5).map((c) => ({ ...c, count: 0 }));
  const winnerBySlug = {};
  ...
  return /* @__PURE__ */ jsx(CookCreateLayout, { breadcrumb: "Cook & Create / Results", children: /* @__PURE__ */ jsxs("div", { className: "relative z-10 space-y-5", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "bg-[#FFFDF9] rounded-2xl border border-[#F0DECA] p-6 shadow-sm", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 items-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center py-4", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-[17px] font-black text-[#5C432E] mb-3", children: "Recipe Reveal" }),
        /* @__PURE__ */ jsx("p", { className: "text-[11px] font-medium text-[#8B7355] mb-2", children: "Your group cooked up..." }),
        /* @__PURE__ */ jsx("p", { className: "text-2xl font-black text-[#E8881E]", children: dishName })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-[#8B7355] mb-1", children: "Average Rating Received Dish" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-1 mb-5", children: [
          [0, 1, 2, 3, 4].map((i) => /* @__PURE__ */ jsx(Star, { size: 22, className: "text-[#E0D4C4]", fill: "#EFE6DA", strokeWidth: 1.5 }, i)),
          /* @__PURE__ */ jsx("span", { className: "ml-2 text-sm font-black text-[#B8A898]", children: "—/5" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-[#8B7355] mb-2", children: "Reactions" }),
        /* @__PURE__ */ jsx("div", { className: "flex flex-wrap justify-center gap-2", children: reactionCards.map((r) => /* @__PURE__ */ jsxs(
          "div",
          {
            className: `flex flex-col items-center bg-white rounded-xl border border-[#F0DECA] px-3 py-2 min-w-[72px] ${r.count === 0 ? "opacity-45" : ""}`,
            children: [
        ...
        !hasReactions && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-[#B8A898] mt-2", children: "No reactions yet — other teams are still tasting." }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-5 items-start", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-[#F8DEBC] rounded-2xl border border-[#F0D0A5] p-6 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2.5", children: funAwards.map((a) => /* @__PURE__ */ jsxs(
          "div",
          {
            className: `bg-white rounded-xl px-3 py-2.5 text-center border border-[#F0DECA] ${a.winner ? "" : "opacity-50"}`,
            children: [
              /* @__PURE__ */ jsx("p", { className: "text-lg leading-none mb-1", children: a.emoji }),
              /* @__PURE__ */ jsx("p", { className: "text-[11px] font-black text-[#3D2E1F] leading-tight", children: a.name }),
              /* @__PURE__ */ jsx("p", { className: "text-[10px] text-[#8B7355] mt-0.5", children: a.winner ?? "—" })
            ]
          },
          a.id
        )) })
