import { U as reactExports, H as isPromise, I as isRedirect, G as isNotFound, C as invariant, h as createControlledPromise, a0 as rootRouteId, J as isServer$1, v as functionalUpdate$1, c as arraysEqual, i as createLRUCache, f as compileDecodeCharMap, a2 as trimPath, $ as rewriteBasepath, g as composeRewrites, T as processRouteTree, S as processRouteMasks, _ as resolvePath, e as cleanPath, a4 as trimPathRight, Q as parseHref, q as executeRewriteInput, E as isDangerousProtocol, V as redirect, u as findSingleMatch, l as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, d as buildRouteBranch, B as interpolatePath, P as nullReplaceEqualDeep, X as replaceEqualDeep$1, M as last, k as decodePath, s as findFlatMatch, t as findRouteMatch, A as hasKeys, r as executeRewriteOutput, n as encodePathLikeUrl, a3 as trimPathLeft, K as joinPaths, a6 as useRouter, m as dummyMatchContext, N as matchContext, y as getDefaultExportFromCjs, Y as requireReactDom, p as exactPathTest, W as removeTrailingSlash, R as React, L as jsxRuntimeExports, F as isModuleNotFoundError, a5 as useHydrated, o as escapeHtml, w as getAssetCrossOrigin, z as getScriptPreloadAttrs, b as appendUniqueUserTags, Z as resolveManifestCssLink, O as Outlet } from "./server-D_Zkyltj.js";
...
const appCss = "/assets/styles-D7rGRvtd.css";
...
const $$splitComponentImporter$e = () => import("./terms-DhnWeo25.js");
...
const $$splitComponentImporter$d = () => import("./results-CjI_b4VL.js");
const Route$d = createFileRoute("/results")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$c = () => import("./profile-Ds2Rle5P.js");
...
const $$splitComponentImporter$b = () => import("./privacy-DpZ5sjf2.js");
...
const $$splitComponentImporter$a = () => import("./payments-kt68zglS.js");
const Route$a = createFileRoute("/payments")({
  beforeLoad: requireOrganizerAuth,
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$9 = () => import("./participants-C4IpEzjG.js");
const Route$9 = createFileRoute("/participants")({
  beforeLoad: requireOrganizerAuth,
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$8 = () => import("./notifications-CUNxEECd.js");
...
const $$splitComponentImporter$7 = () => import("./login-B5jaCv6y.js");
...
const $$splitComponentImporter$6 = () => import("./lobby-BvJZHIrK.js");
const Route$6 = createFileRoute("/lobby")({
  validateSearch: (search) => ({
...
const $$splitComponentImporter$5 = () => import("./groups-MU0ueW2p.js");
...
const $$splitComponentImporter$4 = () => import("./game-DM9US2Gs.js");
...
const $$splitComponentImporter$3 = () => import("./dashboard-BXLY2zte.js");
...
const $$splitComponentImporter$2 = () => import("./create-BoAhE58z.js");
...
const $$splitComponentImporter$1 = () => import("./index-CYJQj28I.js");
...
const $$splitComponentImporter = () => import("./join._linkToken-D1RR50cg.js");
const Route2 = createFileRoute("/join/$linkToken")({
  head: () => ({
    meta: [{
...
const ResultsRoute = Route$d.update({
  id: "/results",
  path: "/results",
  getParentRoute: () => Route$f
});
...
const PaymentsRoute = Route$a.update({
  id: "/payments",
  path: "/payments",
  getParentRoute: () => Route$f
});
const ParticipantsRoute = Route$9.update({
  id: "/participants",
  path: "/participants",
  getParentRoute: () => Route$f
});
...
const LobbyRoute = Route$6.update({
  id: "/lobby",
  path: "/lobby",
  getParentRoute: () => Route$f
});
...
const JoinLinkTokenRoute = Route2.update({
  id: "/join/$linkToken",
  path: "/join/$linkToken",
  getParentRoute: () => Route$f
});
...
export {
  ...
  hashKey as j,
  isOrganizerAuthenticated as k,
  isValidTimeout as l,
  notifyManager as m,
  noop as n,
  resolveQueryBoolean as o,
