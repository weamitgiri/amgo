 ...
 */
exports.getJoinLink = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const { link_token } = req.params;
    if (!link_token) {
        throw new AppError_1.AppError('Invitation link token is required', 400);
    }
    ...
    if (booking.status === 'expired' || booking.status === 'cancelled') {
        throw new AppError_1.AppError('This invitation link is not active', 400);
    }
    ...
    return (0, apiResponse_1.successResponse)(res, 'Invitation link validated', {
